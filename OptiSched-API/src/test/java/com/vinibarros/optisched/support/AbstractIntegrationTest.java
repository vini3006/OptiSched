...
public abstract class AbstractIntegrationTest {
    ...
    // RateLimitingFilter and JwtBlacklistFilter (item A6) sit in the request
    // path of every @SpringBootTest MockMvc call here, including the
    // password-reset flow's own tests — a real Redis is needed for those to
    // run at all, not just for auth-specific tests.
